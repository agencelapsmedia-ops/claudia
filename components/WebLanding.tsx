...
/**
 * WebLanding — Landing page CyberTIA (web uniquement)
 * Charte graphique CyberTIA v1.0
 * Couleurs: Marine #0D2340, Acier #1E6FA8, Cyan #00AACC, Vert #2DB87A, Rouge #E03C3C
 */
...
<body>
  <nav>
    ...
    <ul class="nav-links">
      <li><a href="#features">Fonctionnalit\\u00e9s</a></li>
  ...
  <section class="hero">
    ...
    <div>
      <div class="hero-badge">
        ...
        Propuls\\u00e9 par l'Intelligence Artificielle
      </div>
      <h1>
        <span class="gradient-text">Cybers\\u00e9curit\\u00e9</span><br/>
        Intelligente pour<br/>
        les PME du Qu\\u00e9bec
      </h1>
      <p class="hero-sub">
        CLAUDIA audite, prot\\u00e8ge et optimise votre infrastructure IT en temps r\\u00e9el.
      ...
      <div class="hero-stats">
        <div class="stat"><div class="stat-number">98%</div><div class="stat-label">Taux de d\\u00e9tection</div></div>
        <div class="stat"><div class="stat-number">&lt; 5min</div><div class="stat-label">Audit complet</div></div>
        <div class="stat"><div class="stat-number">200+</div><div class="stat-label">Points de contr\\u00f4le</div></div>
      ...
      <div class="security-badges">
        ...
        <div class="sec-badge">&#x1f1e8;&#x1f1e6; Donn\\u00e9es au Canada</div>
  ...
  <section class="section" id="features">
    <div class="section-label">Fonctionnalit\\u00e9s</div>
    <h2 class="section-title">Tout ce dont votre<br/><span class="gradient-text">infrastructure a besoin</span></h2>
    <p class="section-sub">Une plateforme unifi\\u00e9e pour g\\u00e9rer, auditer et s\\u00e9curiser l'environnement IT de vos clients.</p>
    <div class="features-grid">
      <div class="feature-card">
        <div class="feature-icon icon-blue">&#x1f50d;</div>
        <h3>Audit d'Infrastructure IA</h3>
        <p>Analyse compl\\u00e8te de votre environnement IT en moins de 5 minutes. Serveurs, r\\u00e9seau, cloud, endpoints.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon icon-cyan">&#x1f4ca;</div>
        <h3>Score de S\\u00e9curit\\u00e9 en Temps R\\u00e9el</h3>
        <p>Un score unique de 0 \\u00e0 100 qui refl\\u00e8te l'\\u00e9tat r\\u00e9el de votre cybers\\u00e9curit\\u00e9, mis \\u00e0 jour en continu.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon icon-green">&#x1f916;</div>
        <h3>Recommandations IA</h3>
        <p>CLAUDIA g\\u00e9n\\u00e8re des actions concr\\u00e8tes avec effort estim\\u00e9 et co\\u00fbt. Exactement quoi faire, dans quel ordre.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon icon-orange">&#x1f4cb;</div>
        <h3>Gestion de Projets IT</h3>
        <p>Suivez tous vos projets informatiques — migrations, d\\u00e9ploiements, incidents — avec t\\u00e2ches et budget.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon icon-red">&#x1f6a8;</div>
        <h3>Alertes Critiques</h3>
        <p>D\\u00e9tection proactive des vuln\\u00e9rabilit\\u00e9s : antivirus, serveurs en fin de support, sauvegardes non test\\u00e9es.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon icon-purple">&#x1f4c4;</div>
        <h3>Rapports PDF Professionnels</h3>
        <p>G\\u00e9n\\u00e9rez des rapports d'audit complets en 1 clic. R\\u00e9sum\\u00e9 ex\\u00e9cutif, plan 30/60/90 jours.</p>
      </div>
    </div>
  </section>
  ...
  <section class="score-section" id="dashboard">
    <div class="score-container">
      ...
      <div class="score-content">
        <div class="section-label">Score de S\\u00e9curit\\u00e9</div>
        <h2>Votre posture de<br/><span class="gradient-text">cybers\\u00e9curit\\u00e9 en un coup d'oeil</span></h2>
        <p>CLAUDIA analyse en continu votre infrastructure et calcule un score global bas\\u00e9 sur 200+ points de contr\\u00f4le.</p>
        <div class="risk-items">
          ...
          <div class="risk-item"><div class="risk-dot" style="background:#FF9500"></div><span>Risques \\u00e9lev\\u00e9s</span><span class="risk-count">5</span></div>
          ...
          <div class="risk-item"><div class="risk-dot" style="background:#2DB87A"></div><span>Faibles / R\\u00e9solus</span><span class="risk-count">12</span></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="ai-container">
      ...
      <div class="ai-cards">
        <div class="ai-card featured">
          <div class="ai-tag">IA G\\u00e9n\\u00e9rative</div>
          <h3>Recommandations Intelligentes</h3>
          <p>CLAUDIA g\\u00e9n\\u00e8re un plan d'action prioris\\u00e9 bas\\u00e9 sur votre profil de risque et les meilleures pratiques.</p>
          <ul class="ai-list">
            <li>Priorisation automatique par niveau de risque</li>
            <li>Estimation d'effort et de co\\u00fbt pour chaque action</li>
            <li>Timeline sugg\\u00e9r\\u00e9e : 30, 60 et 90 jours</li>
            <li>Cr\\u00e9ation de projets en 1 clic</li>
          </ul>
        </div>
        <div class="ai-card featured">
          ...
          <ul class="ai-list">
            <li>Serveurs & syst\\u00e8mes d'exploitation</li>
            <li>S\\u00e9curit\\u00e9 r\\u00e9seau & pare-feu</li>
            <li>Cloud, licences & sauvegardes</li>
            <li>Endpoints & antivirus/EDR</li>
            <li>Gestion des acc\\u00e8s & MFA</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="cta-section" id="security">
    <div class="cta-box">
      <div class="section-label">Pr\\u00eat \\u00e0 s\\u00e9curiser votre infrastructure?</div>
  ...
  <footer>
    <div>
      ...
      <div class="footer-tagline">LAPSMEDIA &times; CyberTIA — Cybers\\u00e9curit\\u00e9 pour PME</div>
    </div>
    <ul class="footer-links">
      <li><a href="#features">Fonctionnalit\\u00e9s</a></li>
      <li><a href="#">Tarification</a></li>
      <li><a href="#">Contact</a></li>
      <li><a href="#">Confidentialit\\u00e9</a></li>
    </ul>
    <div class="footer-copy">&copy; 2026 CyberTIA. Tous droits r\\u00e9serv\\u00e9s.</div>
  </footer>
</body>
</html>
`;
